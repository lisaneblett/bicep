...
namespace Bicep.Core.Registry
{
    public class AzureContainerRegistryManager
    {
        ...
        {
            var digestFromRegistry = GetDigest(manifestResponse.GetRawResponse());
        ...
        private static string GetDigest(Response response)
        {
            ...
            throw new InvalidModuleException($"The registry response did not include the {HeaderName} header with the digest.");
        }
